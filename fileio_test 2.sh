...
do
        ...
        echo "Threads = 16, size = 2gb, time = 30"
        sysbench --num-threads=16 --test=fileio --file-total-size=2G --time=30 
--file-test-mode=seqrewr run
...
do
        ...
        echo "Threads = 20, size = 1gb, time = 40"
        sysbench --num-threads=20 --test=fileio --file-total-size=1G --time=40
--file-test-mode=seqrewr run
        sysbench --test=fileio --file-total-size=1G --file-test-mode=rndrw cleanup
done
